...
var github_canlendar = (git_user, git_color) => {
    ...
    function responsiveChart() {
        ...
        var width = c.width = document.getElementById("gitcalendarcanvasbox").offsetWidth;
        var height = c.height = 9 * 0.96 * c.width / git_data.length;
    ...
    function addweek(data) {
        if (git_thisdayindex === 6) {
            ...
            var lastweek = data.contributions[51];
